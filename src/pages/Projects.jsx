...
export default function Projects({ setPage }) {
  ...
  return (
    ...
    >
      ...
      {/* 2. Projects Grid (2 columns on large screen, 1 on mobile) */}
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        {projects.map((project) => (
          ...
          >
            ...
            <div className="w-full aspect-video rounded-3xl overflow-hidden border border-neutral-200/50 shadow-md">
              <img
                src={project.image}
                alt={project.title}
